...
import { Home, Car, User, Heart, Briefcase } from 'lucide-react';
...
const InsuranceCategoryIcons: React.FC<InsuranceCategoryIconsProps> = ({
  ...
  const categories = [
    ...
    {
      id: 'bedrift',
      label: t('insurance.business'),
      icon: Briefcase,
      description: t('insurance.businessDescription')
    }
  ];

  return (
    <div className="mb-6 sm:mb-8 max-w-full overflow-hidden">
      <h3 className="text-base sm:text-lg font-semibold text-foreground mb-3 sm:mb-4 px-1">{t('insurance.selectCategory')}</h3>
